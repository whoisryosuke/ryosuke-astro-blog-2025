...
![Animated GIF of a browser showing the live view of the Next MDX Deck dev server in action alonside someone writing JSX in a MDX file inside VSCode](/blog/2020/creating-speaker-decks-with-nextjs-and-mdx/next-mdx-deck-example-faster.gif)
