...
![An animated GIF demonstrating the use of the plugin to generate a CSS in JS theme from a design system's Figma document with several text and color styles — and pasting the results into VSCode](/blog/2020/syncing-figma-styles-with-css-in-js/generating_theme_JSON_from_figma_styles_-_0.5x.gif)
...
![An animated GIF demonstrating the plugin's ability to accept a JSON theme object inside the `<textarea>` input, clicking a button labeled "import", and generating color styles in the sidebar of a new Figma document.](/blog/2020/syncing-figma-styles-with-css-in-js/importing_CSS_in_JS_theme_and_generating_Figma_color_styles_-_0.5x.gif)
