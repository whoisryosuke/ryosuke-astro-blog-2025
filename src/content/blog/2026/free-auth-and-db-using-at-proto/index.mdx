...
## Adding login to my app

After testing this out, I added it to my piano learning app I’ve been building. The user can create an “offline” account, or login with their AT Proto account to sync their data.

![My piano app on the user profile page with a Cloud Sync section with an AT Proto user profile card, and buttons for syncing data or disconnecting the account.](./Screenshot_2026-03-18_155244.png)

![Initial concepts of the login page in Figma](./Screenshot_2026-03-12_175032.png)
